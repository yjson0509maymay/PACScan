...
[data-testid="stFileUploader"]{background:#071729;border:1px dashed #2764a0;border-radius:7px;padding:3px}[data-testid="stFileUploader"] section{padding:9px!important}.stButton button,.stDownloadButton button{width:100%;background:#0d315d;border:1px solid #2478c8;color:#eaf5ff}.stButton button[kind="primary"]{background:linear-gradient(90deg,#1265d0,#218cff);font-weight:700}.status{text-align:right;color:#34d8ad;font-size:9px;margin:8px}
