...
.st-key-reset_mri_view{display:flex;justify-content:center;align-items:flex-end}.st-key-reset_mri_view button{width:76px!important;height:76px!important;min-width:76px!important;min-height:76px!important;padding:8px!important;border-radius:10px!important}.st-key-reset_mri_view button p{line-height:1.45!important;text-align:center!important}
